...
**2. Is your data demultiplexed or not?**
...
## How to format your fastq files

Assuming your data is already demultiplexed (typical scenario), the way you organize your fastq files depends on which software version you run. 

If you are using the `main` version of the pipeline, you fastq.gz files should be in a folder named seqs. 

If you are using the `home` version of the pipeline, zip all your input into a tar.gz file (e.g. seqs.tar.gz).

**3. Sample information**

In addition to the fastq files, you will need a sample information sheet, and a table saying where your fastq files are.
...
If you are using the **`home`** version, your fastq manifest file should look like this:
For example:
```
sample-id	forward-absolute-filepath	reverse-absolute-filepath
BAQ1370.1.2	${PWD}/seqs/BAQ1370.1.2_75_L001_R1_001.fastq.gz	${PWD}/seqs/BAQ1370.1.2_75_L001_R2_001.fastq.gz
```
